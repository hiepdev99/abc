    ...
    <section class="content-header">
        ...
        <div class="breadcrumb">
            ...
            <a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/content/recyclebin" role="button">
                ...
                rác(<?php $total=$this->Mcontent->content_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
    <!-- Main content -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="public/images/posts/<?php echo $row['img'] ?>"
                                                        alt="<?php echo $row['title'] ?>" class="img-responsive">
                                                </td>
                                                <td><?php echo $row['title']?></td>
                                                <td class="text-center">
                                                    <a
                                                        href="<?php echo base_url() ?>admin/content/status/<?php echo $row['id'] ?>">
                                                        <?php if($row['status']==1):?>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-success btn-xs"
                                                        href="<?php echo base_url() ?>admin/content/update/<?php echo $row['id']?>"
                                                        role="button">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-danger btn-xs"
                                                        href="<?php echo base_url() ?>admin/content/trash/<?php echo $row['id'] ?>"
