    ...
    <section class="content-header">
        ...
        <div class="breadcrumb">
            ...
            <a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/coupon/recyclebin" role="button">
                ...
                rác(<?php $total=$this->Mcoupon->coupon_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
    <!-- Main coupon -->
                                        ...
                                        <tbody>
											...
											?>
                                                ...
                                                <td class="text-center">
                                                    <a
                                                        href="<?php echo base_url() ?>admin/coupon/status/<?php echo $row['id'] ?>">
                                                        <?php if($row['status']==1):?>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-danger btn-xs"
                                                        href="<?php echo base_url() ?>admin/coupon/trash/<?php echo $row['id'] ?>"
