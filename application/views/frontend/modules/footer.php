        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="col-xs-12 col-sm-6">
                    <a href="trang-chu">
                        <img src="public/images/smart-mobi2.png" style="width: 100%;" class="img-fix f-logo"
                    ...
                    <div class="f-contact">
                        ...
                        <ul class="list-unstyled">
                            <li class="clearfix">
                                ...
                                <spad>13 Thanh Đa, Phúc Thọ, Hà Nội </spad>
                            </li>
                            <li class="clearfix">
                                <i class="fa fa-phone"></i>
                                <span>0869305283 - 0862241298</span>
                            </li>
                            <li class="clearfix">
                                <i class="fa fa-envelope"></i>
                                <span><a
                                        href="mailto:duonghiep09021999@gmail.com">duonghiep09021999@gmail.com</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
