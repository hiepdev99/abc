    ...
    <div class="container">
			...
			">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span style="color: black"> 13 Thanh Đa, Phúc Thọ, Hà Nội</span><br>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
                        <span style="color: black">0869305283 - 0862241298</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
                        <span style="color: black"><a
                                href="mailto:sale.24hstore@gmail.com">sale.smartstore@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-12">
            ...
            <div style="margin-top: 15px;">
                <iframe src="public/images/map.png" width="100%" height="400px" frameborder="0" style="border:0"
