                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" placeholder="Họ và tên"
                                                    name="name" value="<?php echo $user['fullname'] ?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control"
                                                    name="<?php if($this->session->userdata('sessionKhachHang')) echo 'tv'; else echo 'email'?>"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="address" placeholder="Địa chỉ giao hàng:"
                                                    ...
                                                    value="<?php echo $user['address'] ?>"></textarea>
                            ...
                            <table class="table" style="color: #333">
                                ...
                                foreach ($data as $key => $value) :
                                    ...
                                    <tr>
                                        ...
                                        <td style="float: right;">
                                            <?php echo number_format($this->Mconfig->config_price_ship()).' VNĐ'; ?>
                                        </td>
                                    </tr>
